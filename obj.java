...
public class obj
{
    ...
    public String Encrypt(String password, SecretKey SecKey) throws Exception
    {
        ...
        String Password = new String(byteCipherText1);
    ...
    public String Decrypt(String pass, SecretKey SecKey) throws Exception
    {
        byte[] byteCipherText = pass.getBytes();
